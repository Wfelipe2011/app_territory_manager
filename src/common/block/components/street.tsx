...
export function Street({ address, actions, block }: AddressProps) {
  ...
  return (
    ...
    >
      <a className='flex cursor-pointer flex-col items-center rounded-full  bg-[#DDF5CE] p-2' href={url} target='_blank'>
      ...
      <Button.Root
        variant='ghost'
        className={clsx('!shadow-non text-primary flex h-8 w-1/12 items-center justify-center !p-0 font-bold')}
